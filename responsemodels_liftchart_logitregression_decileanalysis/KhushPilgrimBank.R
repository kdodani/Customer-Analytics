#1
data <- read.csv("/Users/khushdodani/Desktop/pilgrimBdata.csv")
...
Inc99new
mydata2 <- cbind(mydata1, Age99new, Inc99new)
mydata2
...
Mod5<- lm(Profit99 ~ Online99 + AgeMiss + Age99new  + IncMiss + Inc99new +  + Tenure99 + as.factor(District99), data = mydata2)
summary(Mod5)
Mod6 <- lm(Profit99 ~ Online99 + AgeMiss + Age99new  + IncMiss + Inc99new + I(log(IncZero+1)) + Tenure99 + as.factor(District99),data=mydata2)
summary(Mod6)
